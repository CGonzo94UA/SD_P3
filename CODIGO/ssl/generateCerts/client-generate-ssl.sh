...
KEYSTORE_FILENAME="client.keystore.jks"
VALIDITY_IN_DAYS=3650
DEFAULT_TRUSTSTORE_FILENAME="client.truststore.jks"
TRUSTSTORE_WORKING_DIRECTORY="client_truststore"
KEYSTORE_WORKING_DIRECTORY="client_keystore"
